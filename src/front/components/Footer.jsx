        ...
        <div className="kc-footer__inner">
          ...
          <div className="kc-footer__col">
            ...
            <div className="kc-footer__social">
              <a href="https://instagram.com/kind-connect" className="social-btn ig" target="_blank" rel="noopener noreferrer">IG</a>
              <a href="https://facebook.com/kind-connect" className="social-btn fb" target="_blank" rel="noopener noreferrer">F</a>
              <a href="https://x.com/kind-connect" className="social-btn x" target="_blank" rel="noopener noreferrer">X</a>
              <a href="https://snapchat.com/kind-connect" className="social-btn sc" target="_blank" rel="noopener noreferrer">SC</a>
              <a href="https://tiktok.com/kind-connect" className="social-btn tt" target="_blank" rel="noopener noreferrer">T</a>
              <a href="https://web.telegram.org/kind-connect" className="social-btn tg" target="_blank" rel="noopener noreferrer">TG</a>
            </div>
          </div>
