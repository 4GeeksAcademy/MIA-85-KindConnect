...
export default function CreateDonationForm() {
    const [f, setF] = useState({ title: '', description: '', requester_name: '', requester_email: '', city: '', state: 'TX', category: 'food', kind: 'donation' })
    ...
    async function onSubmit(e) {
        ...
        try {
            const r = await createProject(f); setMsg(`Donation posted (#${r.id})`)
            setF({ title: '', description: '', requester_name: '', requester_email: '', city: '', state: 'TX', category: 'food', kind: 'donation' })
        } catch (e) {
            setErr(e.message)
        }
    }
    ...
    return (
        <div className="container py-4">
            <h1 className="h4">Offer a Food Donation</h1>
